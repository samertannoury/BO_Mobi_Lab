/**
 * @license  OpenTok JavaScript Library v2.2.9.6
 * http://www.tokbox.com/
 *
 * Copyright (c) 2014 TokBox, Inc.
 *
 * Date: November 26 10:28:47 2014
 */
...
(function(window) {
  ...
  OT.properties = {
    version: 'v2.2.9.6',         // The current version (eg. v2.0.4) (This is replaced by gradle)
    build: 'dc876b4',    // The current build hash (This is replaced by gradle)
...
/**
 * @license  TB Plugin 0.4.0.8 dc876b4 HEAD
 * http://www.tokbox.com/
 *
 * Copyright (c) 2014 TokBox, Inc.
 *
 * Date: November 26 10:29:03 2014
 *
 */
...
!(function(window) {
  ...
  OT.PeerConnection = function(config) {
    ...
    var delegateMessage = OT.$.bind(function(type, messagePayload) {
        ...
        //
        // +err+ will be non-null if an err occurred while creating the PeerConnection
  ...
  OT.Publisher = function() {
    ...
    var logAnalyticsEvent = function(action, variation, payloadType, payload) {
        ...
        _createChrome = function() {
          ...
          if(_audioLevelMeter) _audioLevelMeter[_container.audioOnly() ? 'show' : 'hide']();
        },
 ...
 */
  OT.Subscriber = function(targetElement, options) {
    ...
    var setAudioOnly = function(audioOnly) {
      ...
      if (_audioLevelMeter) _audioLevelMeter[audioOnly ? 'show' : 'hide']();
    };
